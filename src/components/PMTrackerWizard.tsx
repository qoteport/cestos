    ...
    <label key={key} className="block space-y-1.5">
      ...
      {key === 'defects_found' || key === 'parts_required' || key === 'remarks' ? (
        ...
        mode === 'ASSISTED' ? (
          ...
          <input
            className={`input-field w-full border-slate-300 focus-visible:ring-2 focus-visible:ring-[#184877] ${mode === 'FREE_FLOW' ? 'rounded-none' : 'rounded-xl'}`}
